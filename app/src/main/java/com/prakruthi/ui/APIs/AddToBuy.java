...
public class AddToBuy {
    ...
    AddToBuy.OnAddToBuyDataFetchedListner mListner;

    public AddToBuy(String productid , String quantity , String id , boolean edit , AddToBuy.OnAddToBuyDataFetchedListner listner)
    {
    ...
    public void fetchData()
    {
        ...
        if (edit)
        {
            executor.execute(new AddToBuy.editBuyItem());
        }
        else
        {
            executor.execute(new AddToBuy.AddtoBuyItem());
        }
    }

...
//                holder.CartProductPrice.setText(cartData.getMartPrice());
            ...
            holder.minus.setOnClickListener(v -> {
                Loading.show(holder.itemView.getContext());
                AddToBuy addToBuy = new AddToBuy(String.valueOf(cartData.getProductId()), String.valueOf(1), String.valueOf(cartData.getId()), true, listner);
                addToBuy.fetchData();
            });
            holder.plus.setOnClickListener(v -> {
                Loading.show(holder.itemView.getContext());
                AddToBuy addToBuy = new AddToBuy(String.valueOf(cartData.getProductId()), String.valueOf(1), "", false, listner);
                addToBuy.fetchData();
            });
